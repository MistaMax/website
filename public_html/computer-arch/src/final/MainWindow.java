...
//		defaultText.setText(getConstants());
	...
	private void initTables()
	{
		...
		{
			if(traceSelect==0)urlValue="http://people.umass.edu/rakeshk/archi/trace1.txt";
			if(traceSelect==1)urlValue="http://people.umass.edu/rakeshk/archi/trace2.txt";
			if(traceSelect==2)urlValue="http://people.umass.edu/rakeshk/archi/trace3.txt";
			if(traceSelect==3)urlValue="http://people.umass.edu/rakeshk/archi/trace4.txt";
		...
		if(memRefTabModel.getRowCount()==0)
		{
			try { 
				...
				urlValue="http://people.umass.edu/rakeshk/archi/data5.txt";
				try {
					url=new URL(urlValue);
