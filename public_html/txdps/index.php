...
<style>
    ...
    h4 {
        color: lightgrey;
        font-family: 'Armata', 'Arial Narrow Bold', sans-serif;
        font-kerning: normal;
    }
.main {
  margin-top: 90px;
...
<div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="services.php" id="navbarDropdownMenuLink" role="menu" data-toggle="dropdown"
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <li class="dropdown-submenu"><a class="dropdown-item" href="driverlicense.html">
              <b class="caret-right"></b>Driver License</a>
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="driverlicense.html">Address Change</a></li>
              <li><a class="dropdown-item" href="driverlicense.html">Driver Record Requests</a></li>
              <li><a class="dropdown-item" href="driverlicense.html">Office Locations</a></li>
              <li><a class="dropdown-item" href="driverlicense.html">Renewal</a></li>
            </ul>
          </li>
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="aboutUs.php" id="navbarDropdownMenuLink" role="menu" data-toggle="dropdown"
          aria-haspopup="true" aria-expanded="false">
          About Us
        </a>
        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <li class="dropdown-submenu"><a class="dropdown-item" href="info.html">
              <b class="caret-right"></b>About Us</a>
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="info.html">General Information</a></li>
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="login.php" id="navbarDropdownMenuLink" role="menu" data-toggle="dropdown"
          aria-haspopup="true" aria-expanded="false">
          Login
        </a>
        <ul class="dropdown-menu">
...
<div class="main">
            ...
            <div class="col">
                <div class="position-relative overflow-hidden p-12 p-md-12 m-md-12 text-center bg-semilight">
                    <div class="col-md-12 p-lg-12 mx-auto my-12">
                        <h4 class="display-3 font-weight-normal" >Courtesy, Service, Protection</h4>
                        <p class = "display-5 font-weight-normal">
                            Proactively protect the citizens of Texas in an ever changing threat environment while always 
                            remaining faithful to the U.S. and State Constitution.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <iframe width="100%" height="500" scrolling="no" frameborder="0" style="border:0" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d6887.461496158739!2d-97.72574866934205!3d30.330175596798213!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8644ca46dcf0be55%3A0x1a342c9d9863d05b!2sTexas+Department+of+Public+Safety!5e0!3m2!1sen!2sus!4v1537033901144" width="600" height="450" frameborder="0" style="border:0" allowfullscreen>
                </iframe>
            </div>
        </div>
    </div>
...
<img id="footSeperator" class="texas.png" src="texas.png" alt="null"/>
<br />
<strong>Note:</strong> links to [PDF] files require <a href="https://get.adobe.com/reader/" title="Adobe" target="_blank">Adobe Reader</a> or another PDF viewer. 
<br />
<br />

|  <a href="/administration/staff_support/human_resources/ADA.htm">Accessibility</a> 
|  <a href="/SitePolicies.htm">Site Policies</a> 
|  <a href="https://www.tsl.texas.gov/trail/index.html">TRAIL</a> 
|  <a href="http://tsiec.region49.org/">TSIEC</a> 
|  <a href="http://gov.texas.gov/">Texas Homeland Security</a> 
|  <a href="/pia.htm">Public Information Act</a> 
|  <a href="/compact/">Compact with Texans</a> |
<br/>
|  <a href="http://gov.texas.gov/disabilities/">The Governor's Committee on People with Disabilities</a> 
|  <a href="/docs/TxFCPrivacyPolicy113010.pdf"> Texas Fusion Center Privacy Policy</a> 
|  <a href="http://www.texas.gov"> texas.gov</a> |
</div>

<div style="text-align: center">
	<br />
	<p>&copy; 2000-2018 Texas Department of Public Safety | HackRice 8 </p>
